#ifndef ESP_CAMERA_HANDLER_H_
#define ESP_CAMERA_HANDLER_H_
...
#elif defined(CONFIG_CAMERA_MODEL_ESP32_CAM_BOARD)
...
#elif defined(CONFIG_CAMERA_MODEL_ESP32S3_CAM_LCD)
#define PWDN_GPIO_NUM     -1
#define RESET_GPIO_NUM    -1
...
#elif defined(CONFIG_CAMERA_MODEL_ESP32S2_CAM_BOARD)
// The 18 pin header on the board has Y5 and Y3 swapped
#define USE_BOARD_HEADER 0
#define PWDN_GPIO_NUM     1
...
#elif defined(CONFIG_CAMERA_MODEL_ESP32S3_EYE)
#define PWDN_GPIO_NUM -1
#define RESET_GPIO_NUM -1
